...
exports.run = (client, message, args) => {
    ...
    if (comando === "perfil" || comando == "pf" || comando == "player") {
                          ...
                          connection.query(`SELECT COUNT(*)username FROM jobs_users WHERE username='${realnome}'`, function (err, countjobsuser, fields) {
                            ...
                            connection.query(`SELECT player_name, food FROM mpdb_health_food_air WHERE player_name='${realnome}' GROUP BY player_name, food`, function (errmpdb, resultmpdbfood, fieldsplayermpdbfood) {
                              ...
                              var resultadocomida = (comidavazia + comidavazia
                                ...
                                + comidavazia + comidavazia + comidavazia + comidavazia)            
                                if(valuefood == 1) resultadocomida = meiacomida+comidavazia+comidavazia+comidavazia+comidavazia+comidavazia+comidavazia+comidavazia+comidavazia+comidavazia;
                                if(valuefood == 2) resultadocomida = comidacheia+comidavazia+comidavazia+comidavazia+comidavazia+comidavazia+comidavazia+comidavazia+comidavazia+comidavazia;                               
                                if(valuefood == 3) resultadocomida = comidacheia+meiacomida+comidavazia+comidavazia+comidavazia+comidavazia+comidavazia+comidavazia+comidavazia+comidavazia;
                                if(valuefood == 4) resultadocomida = comidacheia+comidacheia+comidavazia+comidavazia+comidavazia+comidavazia+comidavazia+comidavazia+comidavazia+comidavazia;
                                if(valuefood == 5) resultadocomida = comidacheia+comidacheia+meiacomida+comidavazia+comidavazia+comidavazia+comidavazia+comidavazia+comidavazia+comidavazia; 
                                if(valuefood == 6) resultadocomida = comidacheia+comidacheia+comidacheia+comidavazia+comidavazia+comidavazia+comidavazia+comidavazia+comidavazia+comidavazia;
                                if(valuefood == 7) resultadocomida = comidacheia+comidacheia+comidacheia+meiacomida+comidavazia+comidavazia+comidavazia+comidavazia+comidavazia+comidavazia;
                                if(valuefood == 8) resultadocomida = comidacheia+comidacheia+comidacheia+comidacheia+comidavazia+comidavazia+comidavazia+comidavazia+comidavazia+comidavazia;
                                if(valuefood == 9) resultadocomida = comidacheia+comidacheia+comidacheia+comidacheia+meiacomida+comidavazia+comidavazia+comidavazia+comidavazia+comidavazia;
                                if(valuefood == 10) resultadocomida = comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+comidavazia+comidavazia+comidavazia+comidavazia+comidavazia;
                                if(valuefood == 11) resultadocomida = comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+meiacomida+comidavazia+comidavazia+comidavazia+comidavazia;                               
                                if(valuefood == 12) resultadocomida = comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+comidavazia+comidavazia+comidavazia+comidavazia;
                                if(valuefood == 13) resultadocomida = comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+meiacomida+comidavazia+comidavazia+comidavazia; 
                                if(valuefood == 14) resultadocomida = comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+comidavazia+comidavazia+comidavazia;
                                if(valuefood == 15) resultadocomida = comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+meiacomida+comidavazia+comidavazia;
                                if(valuefood == 16) resultadocomida = comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+comidavazia+comidavazia;
                                if(valuefood == 17) resultadocomida = comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+meiacomida+comidavazia;
                                if(valuefood == 18) resultadocomida = comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+comidavazia;
                                if(valuefood == 19) resultadocomida = comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+meiacomida;
                                if(valuefood == 20) resultadocomida = comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+comidacheia+comidacheia;
